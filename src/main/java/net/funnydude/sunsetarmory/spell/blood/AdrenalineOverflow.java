...
public class AdrenalineOverflow extends AbstractSpell {
    ...
    public ResourceLocation getSpellResource() {
        return SunsetArmory.id("adrenaline_overflow_spell");
    }
    ...
    public Optional<SoundEvent> getCastFinishSound() {
        return   Optional.of(SoundEvents.PLAYER_ATTACK_NODAMAGE);
    }
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        entity.addEffect(new MobEffectInstance(ModEffects.ADRENALINE_OVERFLOW_EFFECT, (int) (getSpellPower(spellLevel, entity)), 1, false, false, true));

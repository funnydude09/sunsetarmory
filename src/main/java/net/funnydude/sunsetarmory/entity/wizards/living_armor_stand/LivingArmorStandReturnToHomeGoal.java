...
public class LivingArmorStandReturnToHomeGoal extends WaterAvoidingRandomStrollGoal {
    LivingArmorStandEntity mob;
    ...
    public LivingArmorStandReturnToHomeGoal(LivingArmorStandEntity pMob, double pSpeedModifier) {

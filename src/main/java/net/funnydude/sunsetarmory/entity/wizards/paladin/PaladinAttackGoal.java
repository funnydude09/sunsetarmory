...
public class PaladinAttackGoal extends GenericAnimatedWarlockAttackGoal<PaladinEntity> {
    ...
    public PaladinAttackGoal(PaladinEntity abstractSpellCastingMob, double pSpeedModifier, int minAttackInterval, int maxAttackInterval) {

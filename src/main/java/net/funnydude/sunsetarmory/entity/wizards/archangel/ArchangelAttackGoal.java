...
public class ArchangelAttackGoal extends GenericAnimatedWarlockAttackGoal<ArchangelEntity> {
    ...
    public ArchangelAttackGoal(ArchangelEntity abstractSpellCastingMob, double pSpeedModifier, int minAttackInterval, int maxAttackInterval) {
    ...
    protected void onHitFrame(AttackKeyframe attackKeyframe, float meleeRange) {
        ...
        if (attackKeyframe instanceof ArchangelAttackKeyframe fireKeyframe) {

...
public class LivingArmorStandModel extends AbstractSpellCastingMobModel {
    ...
    public void setCustomAnimations(AbstractSpellCastingMob entity, long instanceId, AnimationState<AbstractSpellCastingMob> animationState) {
        if (entity instanceof LivingArmorStandEntity livingArmorStandEntity && livingArmorStandEntity.isArmorStandFrozen()) {
            var pose = livingArmorStandEntity.getArmorstandPose();
            ...
            if (livingArmorStandEntity.helmetJiggle > 0) {
                float f = elastic(1f - ((livingArmorStandEntity.helmetJiggle - partialTick) / JIGGLE_TIME));
                transformStack.pushRotation(this.getAnimationProcessor().getBone(DefaultBipedBoneIdents.HEAD_ARMOR_BONE_IDENT), 0, f, 0);
            }
            if (livingArmorStandEntity.chestJiggle > 0) {
                float f = elastic(1 - (livingArmorStandEntity.chestJiggle - partialTick) / JIGGLE_TIME);
            ...
            if (livingArmorStandEntity.legJiggle > 0) {
                float f = elastic(1 - (livingArmorStandEntity.legJiggle - partialTick) / JIGGLE_TIME);
            ...
            if (livingArmorStandEntity.bootJiggle > 0) {
                float f = elastic(1 - (livingArmorStandEntity.bootJiggle - partialTick) / JIGGLE_TIME);

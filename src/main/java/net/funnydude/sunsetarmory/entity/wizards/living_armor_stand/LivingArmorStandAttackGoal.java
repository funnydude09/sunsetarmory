...
public class LivingArmorStandAttackGoal extends GenericAnimatedWarlockAttackGoal<LivingArmorStandEntity> {
    ...
    public LivingArmorStandAttackGoal(LivingArmorStandEntity abstractSpellCastingMob, double pSpeedModifier, int minAttackInterval, int maxAttackInterval) {

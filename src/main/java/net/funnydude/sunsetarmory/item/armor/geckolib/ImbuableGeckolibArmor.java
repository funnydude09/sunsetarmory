...
public class ImbuableGeckolibArmor extends GeckolibArmor implements IPresetSpellContainer {
    public ImbuableGeckolibArmor(Holder<ArmorMaterial> material, Type type, Properties properties, AttributeContainer... attributeContainers) {
